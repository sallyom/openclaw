...
const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.mlflow.enabled": "MLflow Enabled",
  "diagnostics.mlflow.trackingUri": "MLflow Tracking URI",
  "diagnostics.mlflow.experimentName": "MLflow Experiment Name",
  "diagnostics.mlflow.artifactLocation": "MLflow Artifact Location",
  "diagnostics.mlflow.tags": "MLflow Tags",
  "diagnostics.mlflow.trackTokenUsage": "MLflow Track Token Usage",
  "diagnostics.mlflow.trackCosts": "MLflow Track Costs",
  "diagnostics.mlflow.trackLatency": "MLflow Track Latency",
  "diagnostics.mlflow.trackTraces": "MLflow Track Traces",
  "diagnostics.mlflow.batchSize": "MLflow Batch Size",
  "diagnostics.mlflow.flushIntervalMs": "MLflow Flush Interval (ms)",
  ...
  "diagnostics.langfuse.release": "Langfuse Release",
  "diagnostics.langfuse.environment": "Langfuse Environment",
  "diagnostics.langfuse.flushAt": "Langfuse Flush At",
  "diagnostics.langfuse.flushInterval": "Langfuse Flush Interval",
  "diagnostics.langfuse.requestTimeout": "Langfuse Request Timeout",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "diagnostics.mlflow.enabled": "Enable MLflow experiment tracking (default: false).",
  "diagnostics.mlflow.trackingUri": "MLflow tracking server URI (default: http://mlflow:5000).",
  "diagnostics.mlflow.experimentName": "MLflow experiment name (default: openclaw-default).",
  "diagnostics.mlflow.trackTokenUsage": "Track token usage metrics (default: true).",
  "diagnostics.mlflow.trackCosts": "Track cost metrics in USD (default: true).",
  "diagnostics.mlflow.trackLatency": "Track latency metrics (default: true).",
  "diagnostics.langfuse.enabled": "Enable Langfuse LLM observability (default: false).",
  "diagnostics.langfuse.publicKey": "Langfuse public API key.",
  "diagnostics.langfuse.secretKey": "Langfuse secret API key.",
  "diagnostics.langfuse.baseUrl": "Langfuse base URL (default: https://cloud.langfuse.com).",
