...
const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.opentelemetry.enabled": "OpenTelemetry Enabled",
  "diagnostics.opentelemetry.trackingUri": "MLflow Tracking URI",
  "diagnostics.opentelemetry.experimentName": "MLflow Experiment Name",
  "diagnostics.opentelemetry.experimentId": "MLflow Experiment ID",
  "diagnostics.opentelemetry.otlpEndpoint": "OTLP Endpoint",
  "diagnostics.opentelemetry.artifactLocation": "MLflow Artifact Location",
  "diagnostics.opentelemetry.tags": "Tags",
  "diagnostics.opentelemetry.trackTokenUsage": "Track Token Usage",
  "diagnostics.opentelemetry.trackCosts": "Track Costs",
  "diagnostics.opentelemetry.trackLatency": "Track Latency",
  "diagnostics.opentelemetry.trackTraces": "Track Traces",
  "diagnostics.opentelemetry.batchSize": "Batch Size",
  "diagnostics.opentelemetry.flushIntervalMs": "Flush Interval (ms)",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "diagnostics.opentelemetry.enabled": "Enable OpenTelemetry observability (default: false).",
  "diagnostics.opentelemetry.trackingUri":
    "MLflow tracking server URI (default: http://mlflow:5000).",
  "diagnostics.opentelemetry.experimentName": "MLflow experiment name (default: openclaw-default).",
  "diagnostics.opentelemetry.experimentId": "MLflow experiment ID (alternative to experimentName).",
  "diagnostics.opentelemetry.otlpEndpoint":
    "OTLP endpoint for trace export (default: {trackingUri}/v1/traces).",
  "diagnostics.opentelemetry.trackTokenUsage": "Track token usage metrics (default: true).",
  "diagnostics.opentelemetry.trackCosts": "Track cost metrics in USD (default: true).",
  "diagnostics.opentelemetry.trackLatency": "Track latency metrics (default: true).",
